...
const TargetPreview = memo(
  ({ url, displayUrl }: { url: string; displayUrl: string }) => (
    <div className="flex flex-col h-full bg-card">
      <div className="h-10 bg-background border-b border-border flex items-center px-3 gap-4 shrink-0">
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 bg-card flex flex-col min-w-0 min-h-0 overflow-hidden h-full border-r border-border">
          <MainStage />
        </div>

        {/* ── Right Pane (Sidebar) ── */}
        <aside className="w-[380px] xl:w-[450px] shrink-0 bg-card flex flex-col min-w-0 overflow-hidden">
          <Tabs
            value={sidebarTab}
